...
#define STASH_SIZE 5 // FIXME: FIX THE STASH SIZE IDK WHAT IT SHOULD BE

#define NUM_BYTES_FOR_PATH_TAG 4U
#define NUM_PATH_TAGS NUM_SUBORAMS
#define NUM_TOTAL_BYTES_FOR_PATH_TAGS (NUM_PATH_TAGS * NUM_BYTES_FOR_PATH_TAG)

#define NUM_BYTES_FOR_BLOCK_ADDRESS 4U
#define NUM_TOTAL_BYTES_PER_BLOCK                                              \
  (NUM_TOTAL_BYTES_FOR_PATH_TAGS + NUM_BYTES_FOR_BLOCK_ADDRESS +               \
...
#define NUM_BYTES_PER_ENCRYPTED_BLOCK                                          \
  (AES_IV_SIZE_BYTES + NUM_TOTAL_BYTES_PER_BLOCK + AES_TAG_SIZE_BYTES)
#endif
